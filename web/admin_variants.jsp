...
<head>
    ...
    <style>
        ...
        /* Đang quản lý size của sản phẩm, nên tab Quản lý Sản phẩm vẫn Active */
        ...
        .form-group input:focus { border-color: #0056b3; box-shadow: 0 0 0 3px rgba(0,86,179,0.1); }
        ...
        .btn-submit:hover { background: #059669; transform: translateY(-1px); box-shadow: 0 4px 10px rgba(16,185,129,0.2); }
    </style>
</head>
<body>
    ...
    <div class="content">
        ...
        <h2 class="page-title">
            Quản lý Kho & Size cho Sản phẩm: <span class="product-id-badge">ID ${param.id}</span>
        </h2>
                ...
                <tbody>
                    <c:forEach items="${listV}" var="v">
                        <tr>
                            ...
                            <td class="stock-number">${v.stockQuantity}</td>
                        </tr>
                    </c:forEach>
        ...
        <div class="add-form-container">
            ...
            <form action="addVariantControl" method="post">
                <input type="hidden" name="shoeId" value="${param.id}">
                
                <div class="form-row">
                    <div class="form-group">
                        <label>Nhập Size</label>
                        <input type="text" name="size" placeholder="VD: 40" required>
                    </div>
                    
                    <div class="form-group">
                        <label>Số lượng kho</label>
                        <input type="number" name="stockQuantity" placeholder="VD: 50" min="1" required>
                    </div>
