...
<style>
    ...
    .noti-dropdown { 
        ...
        border: 1px solid #f0f0f0; overflow: hidden; transform: translateY(10px); transition: 0.3s;
    }
    .noti-wrapper:hover .noti-dropdown { visibility: visible; opacity: 1; transform: translateY(5px); }
    .noti-header { padding: 12px 15px; background: #f8f9fa; font-size: 14px; font-weight: bold; border-bottom: 1px solid #eee; }
    .noti-item { padding: 15px; border-bottom: 1px solid #f9f9f9; display: flex; gap: 12px; text-decoration: none; color: #444; font-size: 13px; }
...
<%-- LẤY URI VÀ BIẾN NÓ THÀNH CHỮ THƯỜNG ĐỂ SO SÁNH DỄ HƠN --%>
...
<header class="navbar">
    ...
    <ul class="nav-links">
        <%-- TRANG CHỦ: Active nếu là home hoặc rễ dự án --%>
        <li>
            <a href="home" class="${uri.contains('/home') || uri.endsWith('/') || uri.endsWith('shoestore') ? 'active' : ''}">
                Trang Chủ
            </a>
        </li>
        ...
        <%-- CỬA HÀNG --%>
        <li>
            <a href="shop" class="${uri.contains('/shop') ? 'active' : ''}">
                Cửa Hàng
            </a>
        </li>
        ...
        <%-- GIỚI THIỆU --%>
        <li>
            <a href="about.jsp" class="${uri.contains('about') ? 'active' : ''}">
                Giới Thiệu
            </a>
        </li>
        ...
        <%-- LIÊN HỆ --%>
        <li>
            <a href="contact.jsp" class="${uri.contains('contact') ? 'active' : ''}">
                Liên Hệ
            </a>
        </li>
    </ul>
    ...
    <div class="user-actions">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <a href="login.jsp" style="text-decoration:none; color:#0056b3; font-weight:bold;">Đăng nhập</a>
            </c:otherwise>
        </c:choose>
    </div>
</header>