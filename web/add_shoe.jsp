...
<head>
    ...
    <style>
        ...
        /* Đang ở chức năng Thêm Sản phẩm -> Quản lý Sản phẩm Active */
        ...
        /* Form Container */
        .form-container { background: #fff; padding: 35px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid #f1f5f9; max-width: 800px; }
        ...
        /* Cấu hình chung cho Input và Select */
        .form-group input, .form-group select, .form-group textarea { 
            padding: 12px 15px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14.5px; 
            outline: none; transition: 0.3s; font-family: inherit; color: #1e293b; background-color: #fbfcfd; 
        }
        .form-group input:focus, .form-group select:focus, .form-group textarea:focus { 
            border-color: #0056b3; box-shadow: 0 0 0 3px rgba(0,86,179,0.1); background-color: #fff; 
        }
        ...
        .btn-submit { background: #10b981; color: white; padding: 12px 25px; border: none; border-radius: 8px; font-weight: bold; font-size: 15px; cursor: pointer; transition: 0.3s; display: flex; align-items: center; gap: 8px; }
        .btn-submit:hover { background: #059669; transform: translateY(-2px); box-shadow: 0 4px 10px rgba(16,185,129,0.2); }
...
<body>
    ...
    <div class="content">
        ...
        <h2 class="page-title">
            <i class="fas fa-plus-circle" style="color: #0056b3;"></i> Thêm Sản Phẩm Mới
        </h2>
            ...
            <form action="add" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="discountPrice" placeholder="0" min="0" value="0" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="Nhập bài viết mô tả chi tiết cho đôi giày này..."></textarea>
                </div>
