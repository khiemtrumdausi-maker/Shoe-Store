...
<head>
    ...
    <style>
        ...
        .form-group input, .form-group select, .form-group textarea { padding: 12px 15px; border: 1px solid #cbd5e1; border-radius: 8px; font-size: 14.5px; outline: none; transition: 0.3s; font-family: inherit; color: #1e293b; background-color: #fbfcfd; }
        .form-group input:focus, .form-group select:focus, .form-group textarea:focus { border-color: #0056b3; box-shadow: 0 0 0 3px rgba(0,86,179,0.1); background-color: #fff; }
