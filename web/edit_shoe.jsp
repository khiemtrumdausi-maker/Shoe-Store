...
<body>
    ...
    <div class="content">
        ...
        <h2 class="page-title">
            Chỉnh Sửa Thông Tin Sản Phẩm <span class="product-id-badge">ID: ${detail.id}</span>
        </h2>
            ...
            <form action="edit" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" name="price" value="${detail.price}" placeholder="0" required>
                    </div>
                    
                    <div class="form-group">
                        <label>Giá Sale (VNĐ)</label>
                        <input type="number" name="discount" value="${detail.discountPrice}" placeholder="0" required>
                    </div>
                </div>
